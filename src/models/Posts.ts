...
const post_2 = () => import("../../articles/大话数据结构-数据结构绪论.md")
  ...
  const posts = {"Hadoop Hive 环境搭建": () => import("../../articles/测试.md"),"分布网络-共识算法": () => import("../../articles/分布网络-共识算法.md"),"大话数据结构 - 树 （6）": () => import("../../articles/大话数据结构-树.md"),"大话数据结构 - 串 （5）": () => import("../../articles/大话数据结构-串.md"),"大话数据结构 - 栈与队列 4": () => import("../../articles/大话数据结构-栈与队列.md"),"大话数据结构 - 线性表 3": () => import("../../articles/大话数据结构-线性表.md"),"大话数据结构 - 算法 2": () => import("../../articles/大话数据结构-算法.md"),"大话数据结构 - 数据结构绪论 （1）": () => import("../../articles/大话数据结构-数据结构绪论.md")}
